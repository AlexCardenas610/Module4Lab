    ...
    class ZooAnimals
    {
        public static void RunZooProgram()
        {
            ...
            for (int i = 0; i < numberOfAnimals; i++)
            {
                ...
                // Verifies the names only contain letters
                while (!IsAllLetters(animalName)) 
                {
                    Console.Write("Nanme can only contain letters. Please enter a valid name");
                    animalName = Console.ReadLine();
        ...
        // Method to check if the inputted user string only contains letters
